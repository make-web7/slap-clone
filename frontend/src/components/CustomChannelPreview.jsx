import * as channel from "react-router";
...
const CustomChannelPreview = ({channel, setActiveChannel, activeChannel}) => {
    ...
    return (
        ...
        className={`str-chat__channel-preview-messenger transition-colors flex items-center 
        w-full text left px-4 py-2 rounded-lg mb01 font-medium hover:bg-blue-50/80 min-h-9 ${
            isActive ? "!bg-black/20 !hover:bg-black/20 border-l-8 border-purple-500 shadow-lg text-blue-900" : ""}`}
                >
            <HashIcon className="w-4 h-4 text-9#9b9b9b mr-2" />
