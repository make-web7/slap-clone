...
const UsersList = ({activeChannel}) => {
    ...
    if(isError) return <div className="team-channel-list__error">Error loading users.</div>
    if (!users.length) return <div className="team-channel-list__message">No users found.</div>
            ...
            {users.map((user) => {
                ...
                return (
                    ...
                    >
                        ...
                        <span className="str-chat__channel-preview-messenger--name truncate ml-2">
                            {user.name || user.id}
                        </span>
