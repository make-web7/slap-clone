...
const CreateChannelModal = ({onClose}) => {
    ...
    const validateChannelName = (name) => {
        ...
        if (name.trim().length < 3) return "Channel name must be at least 3 characters"
        if (name.trim().length > 22) return "Channel name must be no more than 22 characters"
                ...
                <form onSubmit={handleSubmit} className="create-channel-modal__form">
                    ...
                    <div className="form-group">
                        ...
                        {channelName && (
                            ...
                            Channel ID will be: #{channelName.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-_]/g, "-")}
                            </div>
                        )}
                    ...
                    <div className="create-channel-modal__actions">
                        ...
                        >{isCreating ? "Creating Channel..." : "Create Channel"}</button>
                    </div>
                </form>
            </div>
        </div>
